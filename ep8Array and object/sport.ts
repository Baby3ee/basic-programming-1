const football = {
    ...
    champion: function(){
        return this.league.standings.filter(function(element,index){ 
            return element.rank === 1 //ใครได้ที่1
        })
    },
topfour: function(){
    return this.league.standings.filter(function(element,index){
        return element.rank < 5 //ใครได้Top4
    })
},
fallingrank: function (){
    return this.league.standings.filter(function(element,index){
        return element.rank > 17 //ใครตกรอบ ทีมบอลมี 20 ทีม 3 ทีมตกรอบ
    })
}

}
console.log(football.fallingrank())
