...
const newMoreFiveDatabase = newDatabase.results.filter(function (element, index) {
    return element.language === "thai" && element.source_name === "Thai Pbs News" //เป็นการเอาข่าวภาาาไทยและจากสำนัก Thai Pbs News
...
console.log(newMoreFiveDatabase)
